...
cd ~/.cocoapods/repos/ConfigPrivatePod && git pull origin master && cd - && pod repo push ConfigPrivatePod __ProjectName__.podspec --verbose --allow-warnings --use-libraries
